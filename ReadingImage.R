...
drawImageWithText <- function(img, text, thresh, fontSize = 5,
  ...
  if (resize) img <- resize(img, 600, 650)
...
img <- load.image("C:\\Users\\anupama25\\Desktop\\Anupama.jpg")

# LOADING THE INPUT STRING
text <- readLines("C:\\Users\\anupama25\\Desktop\\test.txt")

# CALLING FUNCTION TO REPLACE PIXELS WITH CHARACTERS
drawImageWithText(img, text, thresh = .56, fontSize = 5)
